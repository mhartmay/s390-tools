...
volatile struct stage3a_args __section(".loader_parms") loader_parms = { 0 };
...
void __noreturn start(void)
{
	...
	struct ipl_parameter_block *ipib = (void *)args + args->ipib_offs;
	...
	/* test if PV facility is available */
	stfle(S390_lowcore.stfle_fac_list,
	      sizeof(S390_lowcore.stfle_fac_list) / sizeof(S390_lowcore.stfle_fac_list[0]));
